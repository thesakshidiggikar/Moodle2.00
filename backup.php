...
$conn = new mysqli('127.0.0.1:3307', 'root', '', 'moodledb');
...
//     $query = mysqli_query("INSERT INTO REGISTERED(Username,email_id,password ) VALUES($Username,$email_id,$password)" ) ;

//     if ($Username != ' ' || $email != ' ') {
//         $query = mysqli_query("INSERT INTO REGISTERED(Username,email_id,password ) VALUES($Username,$email_id,$password)" ) ;
       
//         echo "<br/></br><span>Registered Successfully !</span>";
//     } else {
//         echo "<br/></br><span>Connection Failed !</span>";
//     };
// }

// $conn->close();;

// $sql="INSERT INTO REGISTERED  VALUSE(
//     Username char(50),
//     email_id char(60),
//     password char(40)) ";
